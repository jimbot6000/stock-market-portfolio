...
function App() {
	...
	const [myName /*, setMyName*/] = useState('Jimmy');
	...
	return showAddStockForm ? (
		<AddStockForm getPortfolio={getPortfolio} addStock={addStock}></AddStockForm>
	) : (
		<div className='App bg-slate-800 text-slate-50'>
			<div className=''>
				...
				<div className='w-11/12 relative'>
					<button className='bg-green-700 hover:bg-green-600 px-3 py-2 rounded-full border-green-800 border-4 my-4 absolute right-0' onClick={addStock}>
						Add stock
					</button>
				</div>
			</div>
